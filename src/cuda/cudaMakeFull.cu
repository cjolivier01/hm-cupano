...
INSTANTIATE_SIMPLE_MAKE_FULL_BATCH(uchar3, float4)
INSTANTIATE_SIMPLE_MAKE_FULL_BATCH(uchar3, half4)
INSTANTIATE_SIMPLE_MAKE_FULL_BATCH(float3, float3)
INSTANTIATE_SIMPLE_MAKE_FULL_BATCH(float3, half4)
INSTANTIATE_SIMPLE_MAKE_FULL_BATCH(float3, float4)
...
INSTANTIATE_SIMPLE_MAKE_FULL_BATCH(half4, half3)
INSTANTIATE_SIMPLE_MAKE_FULL_BATCH(half4, half4)
...
INSTANTIATE_COPY_ROI_BATCHED(half3, half4)
...
INSTANTIATE_COPY_ROI_BATCHED(half4, uchar3)
INSTANTIATE_COPY_ROI_BATCHED(half4, half4)
INSTANTIATE_COPY_ROI_BATCHED(float3, uchar4)
INSTANTIATE_COPY_ROI_BATCHED(float3, float4)
INSTANTIATE_COPY_ROI_BATCHED(float4, float3)
INSTANTIATE_COPY_ROI_BATCHED(uchar3, uchar3)
INSTANTIATE_COPY_ROI_BATCHED(float3, half4)
INSTANTIATE_COPY_ROI_BATCHED(half4, float3)
